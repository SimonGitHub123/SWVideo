#
#  Be sure to run `pod spec lint SWVideo.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/SimonGitHub123/SWVideo.git", :tag => "0.0.3" }
  ...
  s.source_files  = "SWVideo/SnapKit/*", "SWVideo/SWVideoCode/*"
